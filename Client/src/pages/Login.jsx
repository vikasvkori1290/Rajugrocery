  ...
  return (
    <div className="login-portal-layout" style={{ margin: '40px auto' }}>
      <div className="login-card" style={{ maxWidth: '450px', padding: '36px' }}>
        ...
        <p className="login-subtitle">Welcome back! Sign in to access your orders and loyalty rewards.</p>
        ...
        <p style={{ marginTop: '24px', fontSize: '14px', color: '#6B7280' }}>
          Don't have an account? <Link to="/register" style={{ color: '#FF8C42', fontWeight: 700, textDecoration: 'none' }}>Register here</Link>
        </p>
      </div>
    </div>
  );
